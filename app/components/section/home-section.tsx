    ...
    <div className="h-full relative">
      ...
      <div className="flex flex-col items-center text-white mx-10">
        <div className="mt-32 flex flex-col items-center">
          <h4 className="text-2xl md:text-4xl font-semibold up-animation">
            만들고 싶어서 배우는 개발자
          </h4>
          ...
          <p className="mt-10 text-center up-animation text-lg md:text-2xl break-keep delay-3">
            프론트엔드 개발자를 희망합니다. <br />
        ...
        <button
          ...
          className="flex flex-col items-center absolute bottom-[10%] text-white up-animation delay-3"
        >
